...
const signup = async (req, res) => {
 const validationErrors = validationResult(req);// validation function to ensure data entered in the form is correct
  if (!validationErrors.isEmpty()) {
  const errors = validationErrors.array();
  req.flash('errors', errors);
  req.flash('data', req.body); // retrieve user data when there is an error
